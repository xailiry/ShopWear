"""
Django settings for ShopWear project.
...
SECRET_KEY = 'django-insecure-t9-e_)=#+h2foq1+$2*=6(i0acg!v&0y$0ko$(p_$t2ky8fk@^'
...
WSGI_APPLICATION = 'ShopWear.wsgi.application'
